...
class ObservacionesPendientesController extends Controller
{
    public function index(Request $request)
    {
        ...
        $observaciones = Observaciones::with([
            ...
            ->latest()
            ->get()
            // Si un registro pasó por revisión más de una vez, nos
            // quedamos solo con la observación más reciente por
            // actualización (latest() ya ordena desc, así que
            // unique() conserva la primera = la más nueva).
